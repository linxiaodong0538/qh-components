import { openBlock, createElementBlock, createElementVNode, getCurrentScope, onScopeDispose, ref, unref, getCurrentInstance, onMounted, nextTick, watch, computed, warn, provide, inject, isRef, defineComponent, mergeProps, renderSlot, normalizeClass, createVNode, Transition, withCtx, withDirectives, toDisplayString, vShow, normalizeStyle, createCommentVNode, createBlock, resolveDynamicComponent, TransitionGroup, Fragment, renderList, withKeys, withModifiers, shallowRef, useSlots, onBeforeUnmount, toRef, createSlots, shallowReactive, isVNode, render, resolveComponent, resolveDirective, createTextVNode } from "vue";
...
var UploadList = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/upload/src/upload-list.vue"]]);
...
var UploadDragger = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/upload/src/upload-dragger.vue"]]);
...
var UploadContent = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/upload/src/upload-content.vue"]]);
...
var Upload = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/upload/src/upload.vue"]]);
...
const _hoisted_3 = /* @__PURE__ */ createTextVNode("\u786E \u5B9A");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const cascaderMapping = ({ data, value } = {}) => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_el_dialog, {
        ...
        "modal-append-to-body": __props.modalAppendToBody,
        "destroy-on-close": __props.destroyOnClose || false,
        onClose: cancel
      }, {
        footer: withCtx(() => [
          __props.isShowBtn ? (openBlock(), createElementBlock("div", _hoisted_2, [
        ...
        default: withCtx(() => [
          withDirectives((openBlock(), createBlock(_component_el_form, mergeProps({
            ref_key: "myForm",
            ref: myForm,
            model: __props.form,
            rules: __props.rules,
            inline: __props.inline || false,
            ...
            default: withCtx(() => [
              createVNode(_component_el_row, { gutter: 20 }, {
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(__props.options, (opt, idx) => {
                    return openBlock(), createElementBlock(Fragment, {
                      key: "col" + idx
                    }, [
                      !opt.hide ? (openBlock(), createBlock(_component_el_col, {
                        key: 0,
                        span: opt.span || 12
                      }, {
                        default: withCtx(() => [
                          createVNode(_component_el_form_item, {
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                opt.type === "select" ? (openBlock(), createBlock(_component_el_select, {
                                  key: 0,
                                  ...
                                  default: withCtx(() => [
                                    (openBlock(true), createElementBlock(Fragment, null, renderList(opt.options, (item) => {
                                  ...
                                  _: 2
                                }, 1032, ["modelValue", "onUpdate:modelValue", "multiple", "collapse-tags", "placeholder", "disabled", "filterable", "remote", "remote-method", "clearable", "onChange"])) : opt.type === "cascader" ? (openBlock(), createBlock(_component_el_cascader, {
                                  key: 1,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  options: opt.options,
                                  disabled: opt.disabled,
                                  clearable: opt.clearable === void 0 ? true : opt.clearable,
                                  props: opt.props,
                                  onChange: ($event) => change({
                                    category: opt.prop,
                                    value: __props.form[opt.prop],
                                ...
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "options", "disabled", "clearable", "props", "onChange"])) : opt.type === "upload" ? (openBlock(), createBlock(unref(ElUpload), {
                                  key: 2,
                                  class: "avatar-uploader",
                                  action: (_a2 = opt.attrs) == null ? void 0 : _a2.action,
                                  "show-file-list": opt.attrs.showFileList || false,
                                  "on-success": handleAvatarSuccess,
                                  "before-upload": beforeAvatarUpload,
                                  headers: (_b = opt.attrs) == null ? void 0 : _b.headers,
                                  data: (_c = opt.attrs) == null ? void 0 : _c.formData,
                                  disabled: opt.disabled,
                                  "list-type": (_d = opt.attrs) == null ? void 0 : _d.listType,
                                  limit: ((_e = opt.attrs) == null ? void 0 : _e.limit) || 1,
                                  "file-list": (_f = opt.attrs) == null ? void 0 : _f.fileList,
                                  accept: "image/*",
                                  ref_for: true,
                                  ref_key: "uploadFileList",
                                  ref: uploadFileList
                                }, {
                                  default: withCtx(() => [
                                    imageUrl.value ? (openBlock(), createElementBlock("img", {
                                      ...
                                      src: imageUrl.value,
                                      class: "avatar"
                                    }, null, 8, _hoisted_1)) : (openBlock(), createBlock(_component_el_icon, {
                                      key: 1,
                                  ...
                                  _: 2
                                }, 1032, ["action", "show-file-list", "headers", "data", "disabled", "list-type", "limit", "file-list"])) : createCommentVNode("", true),
                                ["date", "year", "month", "week", "dates"].includes(opt.type) ? (openBlock(), createBlock(_component_el_date_picker, {
                                  ...
                                  style: { "width": "100%" }
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "format", "clearable", "placeholder"])) : opt.type === "datetimerange" ? (openBlock(), createBlock(_component_el_date_picker, {
                                  key: 6,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  type: "datetimerange",
                                  ...
                                  style: { "width": "100%" }
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "picker-options", "format", "clearable", "start-placeholder", "end-placeholder"])) : opt.type === "time" ? (openBlock(), createBlock(_component_el_time_picker, {
                                  key: 7,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  "picker-options": {
                                  ...
                                  placeholder: "\u8BF7\u9009\u62E9\u65F6\u95F4"
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "value-format"])) : opt.type === "timerange" ? (openBlock(), createBlock(_component_el_time_picker, {
                                  key: 8,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  "is-range": "",
                                  ...
                                  clearable: opt.clearable || false,
                                  style: { "width": "100%" }
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "start-placeholder", "end-placeholder", "format", "value-format", "clearable"])) : opt.type === "switch" ? (openBlock(), createBlock(_component_el_switch, {
                                  key: 9,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  disabled: opt.disabled
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "disabled"])) : opt.type === "radio" ? (openBlock(), createBlock(_component_el_radio_group, {
                                  key: 10,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  disabled: opt.disabled
                                  ...
                                  _: 2
                                }, 1032, ["modelValue", "onUpdate:modelValue", "disabled"])) : opt.type === "checkbox" ? (openBlock(), createBlock(_component_el_checkbox_group, {
                                  key: 11,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event
                                }, {
                                  ...
                                  _: 2
                                }, 1032, ["modelValue", "onUpdate:modelValue"])) : opt.type === "number" ? (openBlock(), createBlock(_component_el_input_number, {
                                  key: 12,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  disabled: opt.disabled,
                                ...
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "disabled", "controls", "controls-position", "min", "max", "step", "onFocus"])) : ["textarea", "text", "email", "password"].includes(opt.type) ? (openBlock(), createBlock(_component_el_input, {
                                  key: 13,
                                  modelValue: __props.form[opt.prop],
                                  "onUpdate:modelValue": ($event) => __props.form[opt.prop] = $event,
                                  ...
                                  autosize: opt.autosize || void 0,
                                  placeholder: opt.placeholder || void 0,
                                  disabled: opt.disabled,
                                  ...
                                  opt.append ? {
                                    name: "append",
                                    fn: withCtx(() => [
                                      createTextVNode(toDisplayString(opt.append), 1)
                                    ]),
                                    key: "0"
                                  } : void 0,
                                  opt.appendIcon ? {
                                ...
                                ]), 1032, ["modelValue", "onUpdate:modelValue", "suffix-icon", "type", "show-password", "autosize", "placeholder", "disabled", "maxlength", "clearable", "onFocus", "onInput"])) : createCommentVNode("", true)
                              ];
                            }),
                            _: 2
                          }, 1032, ["label", "prop", "size", "rules"])
                        ]),
                        _: 2
                      }, 1032, ["span"])) : createCommentVNode("", true)
                    ], 64);
                  }), 128))
                ]),
                _: 1
            ...
            _: 1
          }, 16, ["model", "rules", "inline", "label-width"])), [
            [_directive_loading, __props.loading]
          ])
        ]),
        _: 1
      }, 8, ["top", "title", "model-value", "width", "fullscreen", "show-close", "append-to-body", "modal-append-to-body", "destroy-on-close"]);
    };
  }
});
var Dialog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4c71c423"]]);
var index = {
  install(app) {
